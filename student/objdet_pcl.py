...
def show_pcl(pcl):
    ...
    def exit_function(vis):
        vis.destroy_window()
        
        
    vis.register_key_callback(262, update_function)
    vis.register_key_callback(32, exit_function)
...
def bev_from_pcl(lidar_pcl, configs):
    ...
    ##TODO      also, store the number of points per x,y-cell in a variable named "counts" for use in the next task
